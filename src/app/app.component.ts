...
import { ServiceBase, ServiceWithProviders, ServicesService } from './services/services.service';
import { FormControl, FormGroup, ReactiveFormsModule, Validators } from '@angular/forms';
import { BehaviorSubject, ReplaySubject, Subject, catchError, combineLatest, distinctUntilChanged, filter, map, scan, shareReplay, startWith, switchMap, take, tap } from 'rxjs';
...
export class AppComponent {
  ...
  teamMemberOffRequest(id: string) {
    console.log(id)
  }
}
